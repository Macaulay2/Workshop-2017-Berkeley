...
<<<<<<< HEAD
	        {\tt frobenius(e,I)} or 
            {\tt frobenius^e(I)} returns the $p^e$-th Frobenius power of $I$,
            $I^{[p^e]}$. If e is nonnegative, then I^{[p^e]} is the ideal generated by all
            f^{(p^e)}, with f in I.
=======
	    {\tt frobenius(e,I)} or {\tt frobenius^e(I)} returns the $p^e$-th 
            Frobenius power of $I$, $I^{[p^e]}$. If $e$ is nonnegative, then 
            $I^{[p^e]}$ is the ideal generated by all powers $f^{p^e}$, 
            with $f \in I$.
>>>>>>> 12cd9b185de79916eea7b8b07548105868f73615
        Example
            R = ZZ/3[x,y];
            I = ideal(x,y);
            frobenius(2,I)
        ...
        Example
            ...
            frobenius(-1,I)
            frobenius(-2,I)
            frobenius(-2,I) == frobeniusRoot(2,I)
        Text
            If $e$ is a nonnegative integer, then {\tt frobenius(e,M)} or 
